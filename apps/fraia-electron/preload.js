...
contextBridge.exposeInMainWorld('fraia', {
  ...
  agentUpdateSettings: (payload) => ipcRenderer.invoke('fraia:agentUpdateSettings', payload),
  ...
  aiSubmitApiKey: (payload) => ipcRenderer.invoke('fraia:aiSubmitApiKey', payload),
